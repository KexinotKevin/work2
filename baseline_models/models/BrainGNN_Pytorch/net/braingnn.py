"""
BrainGNN Network - Modified to support both classification and regression
"""
import torch
...
class Network(torch.nn.Module):
    def __init__(self, indim, ratio, nclass, k=8, R=200, mode='classification'):
        '''

        :param indim: (int) node feature dimension
        :param ratio: (float) pooling ratio in (0,1)
        :param nclass: (int)  number of classes (1 for regression)
